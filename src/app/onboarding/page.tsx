...
const INDUSTRIES = [
  {
    ...
    label: "Svineslagteri",
    emoji: "🐷",
    description: "Svinekød til supermarkeder og eksport",
  },
  {
    id: "kreaturslagteri",
    label: "Kreaturslagteri",
    emoji: "🐄",
    description: "Oksekød og kalv til detailhandel",
  },
  {
    id: "lammeslagteri",
    label: "Lammeslagteri",
    emoji: "🐑",
    description: "Lammekød til restauranter og eksport",
  },
  {
    id: "kyllingslagteri",
    label: "Kyllingslagteri",
    emoji: "🐔",
    description: "Fjerkræ til industri og detailhandel",
  },
];
...
export default function OnboardingPage() {
  ...
  const [industry, setIndustry] = useState("svineslagteri");
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="card space-y-6">
          ...
          {/* Industri */}
          <div>
            <label className="label">Vælg type slagteri</label>
            <div className="grid grid-cols-2 gap-3">
              {INDUSTRIES.map(ind => (
                ...
                >
                  ...
                  <div className="text-xs text-stone-500 mt-0.5">{ind.description}</div>
                </button>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              type="text"
              placeholder={`fx. Jørgensens ${selectedIndustry.label} A/S`}
              value={companyName}
          ...
          <div className="bg-stone-800/50 rounded-lg p-4 text-sm text-stone-400 space-y-1">
            <div className="flex justify-between"><span>Type</span><span className="text-stone-300">{selectedIndustry.emoji} {selectedIndustry.label}</span></div>
